                                ...
                                <table class="table table-hover mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="d-none d-xl-table-cell"><i class="bi bi-receipt"></i> Bill No.
                                            </th>
                                            ...
                                            <th class="d-none d-xl-table-cell"><i class="bi bi-file-earmark"></i>
                                                Drawing</th>
                                            <th class="d-none d-lg-table-cell"><i class="bi bi-person-check"></i>
                                                Approved</th>
                                    ...
                                    <tbody>
                                        @forelse($projects as $project)
                                            <tr>
                                                ...
                                                <td class="d-none d-xl-table-cell">{{ $project->reference_drawing }}
                                                </td>
