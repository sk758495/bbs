...
class SingleProjectExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, WithCustomStartCell, WithEvents
{
    protected $projectId;
    ...
    {
        return ProjectDetail::with('user')->where('id', $this->projectId)->get();
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $project = ProjectDetail::with('user')->find($this->projectId);
                
                // Add title
                $sheet->setCellValue('A1', 'Bar Bending Schedule (BBS) - Project: ' . $project->project_name);
